...
BEGIN
    INSERT INTO investigadores(empresa,NoDocumento,TipoDocumento,CiudadExp,Nombres,Apellidos,CorreoInvest,FirmaDigital,Estado)
    VALUES(parempresa,parNoDocumento,parTipoDocumento,parCiudadExp,parNombres,parApellidos,parCorreoInvest,parFirmaDigital,'A');
